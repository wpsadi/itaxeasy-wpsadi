  ...
  return (
    <div className=" p-8 bg-white">
      ...
      <p className="text-lg p-10">
        * Discontinued with effect from December 20, 2015 National Saving
        Certificates (IXth Issue):- These certificates are issued with effect
        from December 1, 2011. Maturity period of 10 years and interest is
        accrued at the rate of 8.7 percent (8.9 percent if investment made on or
        after April 1, 2012) and 8.8 per cent(if investment made on or after
        April 1, 2013) which is compounded half yearly. However, interest is
        taxable on yearly basis according to the rates given above.
      </p>
