...
export default function DepreciationTable(){
    ...
    const handleDownloadPDF = async () => {
        const element = document.querySelector("#DepriciationTable") as HTMLElement | null;
            ...
            <Table className="table-auto border-collapse border border-gray-500 text-lg">
                ...
                <TableBody>
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">A.Y 2018-19 onwards</TableCell>
                        <TableCell className="border border-gray-500">A.Y. 2006-07 to 2017-18</TableCell>
                        <TableCell className="border border-gray-500">A.Y. 2003-04 to 2005-06</TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">Buildings which are used mainly for residential purposes except hotels and boarding houses</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    </TableRow>
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">Building other than those used mainly for residential purposes and not covered by sub-items (1) above and (3) below</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    </TableRow>
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">	Building acquired on or after the 1st day of September, 2002 for installing machinery and plant forming part of water supply project or water treatment system and which is put to use for the purpose of business of providing infrastructure facilities under clause (i) of sub-section (4) of section 80-IA</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    </TableRow>
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">Purely temporary erections such as wooden structures</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    </TableRow>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">Furniture and Fittings including electrical fittings [See Note 5 below the Table]</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    </TableRow>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">Machinery and plant other than those covered by sub-items (2), (3) and (8) below</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    </TableRow>
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">Motor cars, other than those used in a business of running them on hire, acquired or put to use on or after the 1st day of April, 1990</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    </TableRow>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        Air Pollution control equipment being <br/>
                            ...
                            (d) Scrubber-counter current/venturi/packed-bed/cyclonic scrubbers<br/>
                            (e) Ash handling system and evacuation being<br/>
                        </TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">
                        Water pollution control equipment being (a) Mechanical screen systems <br/>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">
                      (a) Solidwaste control equipments, being- caustic/lime/chrome/mineral/ cryolite recovery system<br/>
                      (b) Solidwaste recycling and resource recovery systems<br/>
                        </TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">
                        Mines and quarries (a) Tubs, winding ropes, haulage rope and sand stowing pipes
                        (b) Safety lamps
                        </TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">
                        Instrumentation and monitoring system energy flows; <br/> (a) Automatic electrical load monitoring systems<br/>
                        (b) Digital heat loss meters<br/>
                        (c) Micro-processor based control systems<br/>
                        (d) Infra-red thermography<br/>
                        (e) Meters for measuring heat losses, furnace oil flow, stream flow, electric energy and power factor meters<br/>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">
                        Waste heat recovery equipments; (a) Economisers and feed water heaters<br/>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">
                        Co-Generation systems; (a) Back pressure pass out, controlled extraction, extraction-cum- condensing turbines for co-generation along with pressure boilers <br/>
                        (b) Vapour absorption refrigeration systems<br/>
                        (c) Organic rankine cycle power systems<br/>
                        (d) Low inlet pressure small steam turbines<br/>
                        </TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">
                        Electrical equipments (a) Shunt capacitors and synchronous condenser systems <br/>
                        ...
                        (l) Special energy meters for Availability Based Tariff (ABT)<br/>
                        </TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        (c) Burners using air with high pre-heat temperature (above 300’ C)<br/>
                        </TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">
                            Other equipment; (a) Wet air oxidation equipment for recovery of chemicals and heat<br/>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">
                        Mineral Oil concerns (a) Plant used in field operations (above ground), distribution-Returnable <br/>
                        (b) Plant used in field operations (below ground), but not including kerbside pumps including underground tanks and fitting used in field operations (distribution) by mineral oil concerns<br/>
                        </TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">
                        Renewal energy devices being- (a) Flat plate solar collectors <br/>
                        ...
                        (l) Wind mills and any specially designed devices which run on wind mills<br/>
                        (m) Any special devices including electric generators and pumps running on wind energy<br/>
                        ...
                        (r) Machinery and plant used in the manufacture of any of the above sub-items<br/>
                        </TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">
                        Books owned by assessees carrying on a profession (a) Books, being annual publications <br/>
                        (b) Books, other than those covered by entry<br/> (a) above<br/>
                        </TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        <TableCell className="border border-gray-500 font-bold" colSpan={2} >
                        IV. Ships
                        </TableCell>
                        <TableCell className="border border-gray-500"></TableCell>
                        <TableCell className="border border-gray-500"></TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        <TableCell className="border border-gray-500" colSpan={5} >
                            ...
                            A building shall be deemed to be a building used mainly for residential purposes, if the built-up floor area thereof used for residential purposes is not less than sixty-six and two their per cent of its total built up floor area and shall include any such building in the factory premises.
                            ...
                            “Speed boat” means a motor boat driven by a high speed internal combustion engine capable of propelling the boat at a speed exceeding 24 kilometres per hour in still water and so designed that when running at a speed, it will rise from the water.
                        </TableCell>
