...
export default function IntrestOnKVP(){
    return (
        ...
        <div className="flex justify-end">
            <Button className="bg-blue-500 text-white" variant={"secondary"}>Download PDF</Button>
        </div>
        <div className="container flex m-10">
            <Table className="table-auto border-collapse border border-gray-500 text-lg">
                <TableHeader className="bg-blue-500 text-white">
                    ...
                    Period From the Date of certificate to the date of its encashment
                    </TableHead>
                    <TableHead className="text-white border border-gray-500">
                    1st Year
                    </TableHead>
                ...
                <TableBody>
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">Purchased from 2.9.1993 to 31.12.1998</TableCell>
                    ...
                    <TableRow className="border-b border-gray-500">
                        ...
                        <TableCell className="border border-gray-500">Purchased from 7 years and 6 Months</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
                        <TableCell className="border border-gray-500">TableValue1</TableCell>
