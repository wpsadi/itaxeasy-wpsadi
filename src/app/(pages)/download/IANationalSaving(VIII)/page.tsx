  ...
  return (
    <div className=" p-8 bg-white">
      ...
      <p className="text-lg p-10">
        * Maturity period 5 years Note: 1. Deduction u/s 80L is available on the
        accrued interest up to A.Y. 2005-06. From A.Y. 2006-07 section 80L has
        been deleted. 2. Accrued interest qualifies for rebate u/s 88 except for
        the maturing year up to A.Y. 2005-06. From A.Y. 2006-07, the accrued
