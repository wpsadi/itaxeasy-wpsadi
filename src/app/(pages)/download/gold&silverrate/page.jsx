  ...
  return (
    <div className="p-8 bg-white">
      ...
      <div id="gold-silver-table">
            ...
            <TableBody>
              {jsonData.data.map((item) => (
                <TableRow key={item.id} className="border-b border-gray-500">
                  ...
                  <TableCell className="border border-gray-500">
                    {item.stGoldRate24CPer10Grams}
                  </TableCell>
                  <TableCell className="border border-gray-500">
                    {item.stSilverRateFor1Kg}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
        ...
        <p className="text-lg">
          Notes : 1. Value of gold contained in gold ornaments should be reduced
          by 14 to 20 per cent of ruling rates of standard gold, as per the
          practice prevalent in the bullion market and the amount of reduction
        ...
        <div className="m-10">
          <Table className="table-auto border-collapse border border-gray-500 text-lg">
            <TableHeader className="bg-blue-500 text-white">
              <TableRow className="border-b border-gray-500">
                <TableHead className="text-white border border-gray-500 w-[60%]"></TableHead>
                <TableHead className="text-white border border-gray-500">
            ...
            <TableBody>
              ...
              <TableRow className="border-b border-gray-500">
                <TableCell className="font-medium border border-gray-500">
                  Soldering made of copper, silver, etc., used in making
                  ornaments
                </TableCell>
                <TableCell className="border border-gray-500">
                  2.5% to 5%
              ...
              <TableRow className="border-b border-gray-500">
                <TableCell className="font-medium border border-gray-500">
                  Shortage of gold in melting, mint charges payable to
                  Government, expenditure on freight, insurance, etc., of
                  sending gold ornaments to approved mint for conversion into
                  standard gold bars
                </TableCell>
              ...
              <TableRow className="border-b border-gray-500">
                <TableCell className="font-medium border border-gray-500">
                  Margin of profit of the dealer when ornaments are sold in
                  market
                </TableCell>
