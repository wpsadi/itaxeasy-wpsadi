...
export default function Page() {
  ...
  const [BreakupAmount6Alines, BreakupAmount6AsetLines] = useState(
    BreakupAmount6AinitialLines
  );
  ...
  const [BreakupAmount10lines, BreakupAmount10setLines] = useState(
    BreakupAmount10initialLines
  );
  ...
  const [CentralGovtChallanlines, CentralGovtChallansetLines] = useState(
    CentralGovtChallaninitialLines
  );
  ...
  const [CentralGovtTaxlines, CentralGovtTaxSetLines] = useState(
    initialCentralGovtTaxLines
  );
  ...
  const initialData: RowData[] = ["Q1", "Q2", "Q3", "Q4"].map(
    (quarter, index) => ({
      quarter,
  ...
  const calculateTotal = (field: keyof RowData): number => {
    return rows.reduce(
      (total, row) => total + (typeof row[field] === "number" ? row[field] : 0),
      0
    );
  };
    ...
    <div className=" p-8 bg-white">
      ...
      <div className="container flex m-10" id="form16">
        <Table className="border border-neutral-900">
          {/* Table Caption */}
          <TableCaption className="text-center font-semibold">
            FORM NO. 16
          </TableCaption>
          ...
          <TableBody>
            <TableRow>
              <TableCell
                className="px-2 py-4 text-sm font-bold text-gray-900 text-center"
                colSpan={12}
              >
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-4 text-sm font-medium text-neutral-500 border border-neutral-600"
                colSpan={15}
              >
                <input
                  className="focus:outline-none no-border w-full text-neutral-500 font-medium text-left bg-white"
            ...
            <TableRow>
              ...
              <TableCell
                className="py-4 text-sm font-bold text-gray-900 col-span-1 border border-neutral-600"
                colSpan={2}
              >
                From
                <input
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-4 text-sm font-bold text-gray-950 border border-neutral-600 text-justify"
                colSpan={18}
              >
              ...
              <TableRow key={index}>
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange(e, index, "taxDeposited")
                    }
                  />
                </TableCell>
              </TableRow>
            ...
            <TableRow>
              <TableCell
                className="px-2 py-4 text-md font-extrabold text-gray-900 border border-neutral-600 col-span-1"
                colSpan={20}
              >
                Verification
              </TableCell>
            ...
            <TableRow>
              <TableCell
                className="px-10 py-10 text-sm font-bold text-gray-900 border border-neutral-600 col-span-1 text-justify leading-6"
                colSpan={18}
              >
                I,{" "}
                <input className="text-left border-b-2 -border--clr-neutral-900 outline-none w-1/3 ml-2 bg-white " />
                , son/daughter of
                <input className="text-left border-b-2 -border--clr-neutral-900 outline-none w-1/3 ml-2 bg-white " />
            ...
            <TableRow>
              <TableCell
                className="px-2 py-2 text-sm font-bold text-gray-900 border border-neutral-600 col-span-1 text-left"
                colSpan={1}
              ></TableCell>
              <TableCell className="px-2 py-2 text-sm font-medium text-neutral-500 border border-neutral-600 col-span-3 text-left">
                <input className="border-none bg-white focus:outline-none text-left w-full" />
              </TableCell>
              <TableCell
                className="px-2 py-8 text-sm font-medium text-neutral-500 border border-neutral-600 col-span-8 row-span-2 text-left"
                colSpan={18}
              >
            ...
            <TableRow>
              <TableCell className="px-2 py-2 text-sm font-medium text-neutral-500 border border-neutral-600 col-span-4 text-left">
                ...
                <input className="text-left w-3/4 bg-white outline-none" />
              </TableCell>
            ...
            <TableRow>
              <TableCell
                className="py-4 border border-neutral-600 text-sm font-medium text-neutral-500 "
                colSpan={18}
              >
                ...
                year, Part &apos;A&apos; of the certificate in Form No.16 issued
                for the quarter ending on 31st March of the financial year shall
                contain the details of tax deducted and deposited for all the
            ...
            <TableRow>
              <TableCell
                className="py-4 text-sm font-bold text-gray-900 underline col-span-12 text-center"
                colSpan={18}
              >
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-2 text-sm font-bold text-gray-900 border border-neutral-600 "
                colSpan={2}
              >
                Description
              </TableCell>
              <TableCell
                className="px-2 py-2 text-sm font-bold text-gray-900 border border-neutral-600 col-span-9"
                colSpan={14}
              >
                Definition
              </TableCell>
            ...
            <TableRow>
              <TableCell
                className="px-2 py-4 text-sm font-bold text-gray-900 border border-neutral-600  text-left"
                colSpan={1}
              >
                U
              </TableCell>
              <TableCell
                className="px-2 py-4 text-sm font-medium text-neutral-500 border border-neutral-600 text-left"
                colSpan={2}
              >
                Unmatched
              </TableCell>
              <TableCell
                className="px-2 py-2 text-sm font-medium text-neutral-500 border border-neutral-600 text-left"
                colSpan={14}
              >
            ...
            <TableRow>
              ...
              >
                ...
                Accounts Officer (PAO) statement
              </TableCell>
            </TableRow>
        ...
        <Table className=" pt-20">
          <TableHeader className="bg-white">
            <TableRow>
              <TableCell
                colSpan={12}
                className="text-center border border-neutral-900"
              >
          ...
          <TableBody className="bg-white">
            <TableRow>
              <TableCell
                colSpan={12}
                className="text-center text-lg font-bold text-gray-900 border border-neutral-900"
              >
                <h6>PART B</h6>
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell
                colSpan={12}
                className="text-center text-sm font-bold text-gray-900 border border-neutral-900 px-2 py-2"
              >
                Certificate under section 203 of the Income-tax Act, 1961 for
                tax deducted at source on salary paid to an employee under
                section 192 or pension/interest income of specified senior
            ...
            <TableRow>
              <TableCell
                className="text-sm font-bold text-gray-900 border border-neutral-600 text-left px-2 py-4"
                colSpan={2}
              >
                Certificate No.
                <input className="bg-white focus:outline-none w-64 mx-2 text-neutral-500 font-medium border-b border-gray-300" />
              </TableCell>
              <TableCell
                className="text-sm font-bold text-gray-900 border border-neutral-600 text-left px-2 py-4"
                colSpan={10}
            ...
            <TableRow>
              <TableCell
                className="text-sm font-bold text-gray-900 border border-neutral-600 px-2 py-4"
                colSpan={2}
              >
                Name and address of the Employer/Specified Bank
              </TableCell>
            ...
            <TableRow>
              <TableCell
                className="text-sm font-medium text-neutral-500 border border-neutral-600 px-2 py-4"
                colSpan={2}
              >
                <textarea className="bg-white text-neutral-500 font-medium w-full h-28 resize-none px-2 py-2 text-justify outline-none border border-gray-300" />
              </TableCell>
              <TableCell
                className="text-sm font-medium text-neutral-500 border border-neutral-600 px-2 py-4"
                colSpan={10}
            ...
            <TableRow>
              <TableCell
                ...
                className="px-2 py-4 text-sm font-medium text-neutral-500 border border-neutral-600"
              >
                <input className="bg-white w-full border-0 text-neutral-500 font-medium text-left" />
              </TableCell>
              <TableCell
                colSpan={2}
                className="px-2 py-4 text-sm font-medium text-neutral-500 border border-neutral-600"
              >
                <input className="bg-white w-full outline-none text-neutral-500 font-medium text-left" />
              </TableCell>
              <TableCell
                colSpan={11}
                className="px-2 py-4 text-sm font-medium text-neutral-500 border border-neutral-600"
            ...
            <TableRow>
              <TableCell
                colSpan={1}
                className="px-2 py-4 text-sm font-bold text-gray-900 border border-neutral-600"
              >
                CIT (TDS)
              </TableCell>
              <TableCell
            ...
            <TableRow>
              <TableCell
                ...
                className="px-2 py-4 text-sm font-medium text-neutral-500 border border-neutral-600"
              >
                <textarea className="bg-white w-full h-28 resize-none px-2 py-2 text-neutral-500 font-medium outline-none border border-gray-300" />
              </TableCell>
              <TableCell
                colSpan={2}
                className="px-2 py-4 text-sm font-medium text-neutral-500 border border-neutral-600"
              >
                <input className="bg-white w-full outline-none px-2 py-4 text-neutral-500 font-medium" />
              </TableCell>
              <TableCell
                colSpan={1}
                className="py-4 text-sm font-bold text-gray-900 border border-neutral-600"
              >
                From{" "}
                <input className="mx-2 w-3/4 outline-none bg-white text-neutral-500 font-medium text-center py-4" />
              </TableCell>
              <TableCell
                colSpan={7}
                className="py-4 text-sm font-bold text-gray-900 border border-neutral-600"
              >
                To{" "}
                <input className="w-4/5 mx-2 outline-none bg-white text-neutral-500 font-medium text-center py-4" />
              </TableCell>
            </TableRow>
            ...
            <TableRow>
              <TableCell
                colSpan={12}
                className="px-2 py-4 text-sm font-bold text-gray-900 text-right border border-neutral-600"
              >
                Annexure-I
              </TableCell>
            </TableRow>
            ...
            <TableRow>
              <TableCell
                colSpan={12}
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 text-center"
              >
            ...
            <TableRow>
              ...
              <TableCell
                colSpan={4}
                className=" text-center px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600"
              >
                No
              </TableCell>
            </TableRow>
            ...
            <TableRow>
              <TableCell
                colSpan={1}
                className="px-2 py-2 text-sm font-semibold text-gray-900 text-center border border-neutral-600"
              >
                1.
              </TableCell>
              <TableCell
            ...
            <TableRow>
              ...
              <TableCell
                colSpan={2}
                className="px-2 py-2 text-sm font-semibold text-gray-900 text-left border border-neutral-600"
              >
                Salary as per provisions contained in section 17(1)
              </TableCell>
              <TableCell
                colSpan={1}
                className="px-2 py-2 text-sm font-semibold text-neutral-500 text-left border border-neutral-600"
              >
                <input type="number" className="border-none" />
              </TableCell>
              <TableCell
                colSpan={8}
                className="px-2 py-2 text-sm font-semibold text-neutral-500 text-right border border-neutral-600"
              >
                <input type="number" className="border-none" />
              </TableCell>
            </TableRow>
            ...
            <TableRow>
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 text-center col-span-1"
                colSpan={1}
              >
                (b)
              </TableCell>
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 text-left col-span-7"
                colSpan={2}
              >
              ...
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-neutral-500 border border-neutral-600 text-left col-span-2"
                colSpan={1}
              >
                <input type="number" className="border-none" />
              </TableCell>
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-neutral-500 border border-neutral-600 text-right col-span-2"
                colSpan={8}
              >
                <input type="number" className="border-none" />
              </TableCell>
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 text-left col-span-9"
                colSpan={2}
              >
                Total
              </TableCell>
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 text-left col-span-11"
                colSpan={11}
              >
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 text-right col-span-2"
                colSpan={8}
              />
            </TableRow>
            <TableRow>
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 col-span-7 text-left"
                colSpan={2}
              >
              ...
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-neutral-500 border border-neutral-600 col-span-2 text-left"
                colSpan={1}
              >
                <input type="number" className="border-none" />
              </TableCell>
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-2 text-sm font-extrabold text-gray-900 border border-neutral-600 col-span-7 text-left"
                colSpan={2}
              >
              ...
              <TableCell
                className="px-2 py-2 text-sm font-extrabold text-neutral-500 border border-neutral-600 col-span-2 text-left"
                colSpan={8}
              >
                <input
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 col-span-2 text-center"
                colSpan={1}
              >
                Gross Amount
              </TableCell>
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-neutral-500 border border-neutral-600 col-span-2 text-right"
                colSpan={1}
              >
                <input
            ...
            <TableRow className="bg-white">
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 text-center col-span-6"
                colSpan={2}
              />
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 text-center col-span-2"
                colSpan={1}
              >
                Gross Amount
              </TableCell>
            ...
            <TableRow className="bg-white">
              ...
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 text-left col-span-5"
                colSpan={1}
              >
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-neutral-500 border border-neutral-600 col-span-6 text-left"
                colSpan={8}
              >
                <input type="number" className="border-none" />
              </TableCell>
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-2 text-sm font-extrabold text-gray-900 border border-neutral-600 col-span-6 text-left"
                colSpan={8}
              >
                <input
            ...
            <TableRow>
              ...
              <TableCell
                className="px-2 py-2 text-sm font-semibold text-gray-900 border border-neutral-600 col-span-6 text-right"
                colSpan={8}
              >
                <input type="number" className="border-none" />
              </TableCell>
            ...
            <TableRow>
              <TableCell className="text-center font-semibold text-gray-900 border border-neutral-600">
                15.
              </TableCell>
              ...
              <TableCell
                className="text-right font-semibold text-gray-900 col-span-6 border border-neutral-600"
                colSpan={8}
              >
                <input type="number" className="border-none" />
              </TableCell>
            ...
            <TableRow>
              <TableCell
                className="text-sm font-bold text-gray-900 col-span-1 text-justify leading-6 border border-neutral-600 p-20"
                colSpan={10}
              >
                I,
                <input className="text-left border-b-2 -border--clr-neutral-900 outline-none w-1/3 ml-2 bg-white " />
                , son/daughter of{" "}
                <input className="text-left border-b-2 -border--clr-neutral-900 outline-none w-1/3 bg-white" />
                .Working in the capacity of{" "}
                <input className="text-left border-b-2  -border--clr-neutral-900 outline-none w-1/3 bg-white" />
            ...
            <TableRow>
              ...
              <TableCell className="px-2 py-2 text-sm font-medium text-neutral-500 border border-neutral-600 col-span-5 text-left h-full">
                <input className="border-none w-full h-full focus:outline-none text-left bg-white" />
              </TableCell>
              <TableCell
                className="px-2 py-2 text-sm font-bold text-gray-900 border border-neutral-600 col-span-2 text-left"
                colSpan={14}
              >
                (Signature of person responsible for deduction of Tax)
              </TableCell>
            ...
            <TableRow>
              ...
              <TableCell className="px-2 py-2 text-sm font-medium text-neutral-500 border border-neutral-600 col-span-5 text-left">
                <input className="border-none focus:outline-none text-left bg-white" />
              </TableCell>
              <TableCell className="px-2 py-2 text-sm font-bold text-gray-900 border border-neutral-600 col-span-2 text-left">
                Full Name:
              </TableCell>
              <TableCell
                className="px-2 py-2 text-sm font-medium text-neutral-500 border border-neutral-600 col-span-4 text-left"
                colSpan={10}
              >
                <input className="border-none focus:outline-none text-left bg-white" />
              </TableCell>
            ...
            <TableRow>
              ...
              <TableCell className="px-2 py-2 text-sm font-bold text-gray-900 border border-neutral-600 col-span-5">
                Particular of Amount for any other exemption under section 10
                Rs.
              </TableCell>
            ...
            <TableRow>
              <TableCell
                className="px-2 py-2 text-sm font-bold text-gray-900 border border-neutral-600 col-span-12 text-left"
                colSpan={10}
              >
            ...
            <TableRow>
              ...
              <TableCell className="text-sm font-bold text-gray-900">
                Particular of Amount deductible under any other provision(s) of
                Chapter VIA Rs.
              </TableCell>
              <TableCell className="text-sm font-bold text-gray-900">
                Gross Amount Rs.
            ...
            <TableRow className="border-neutral-600">
              ...
              <TableCell className="text-sm font-medium text-neutral-500">
                <input className="border-none focus:outline-none text-left w-full bg-white" />
              </TableCell>
              <TableCell
            ...
            <TableRow className="border-neutral-600">
              ...
              <TableCell className="text-sm font-medium text-neutral-500">
                <input className="focus:outline-none text-left w-full bg-white" />
              </TableCell>
              <TableCell className="text-sm font-bold text-gray-900">
                Full Name:
              </TableCell>
              <TableCell className="text-sm font-medium text-neutral-500">
                <input className="outline-none text-left w-full bg-white" />
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
