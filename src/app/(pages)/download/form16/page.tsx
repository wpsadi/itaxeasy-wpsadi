...
<TableRow>
  <TableCell className="text-center text-sm font-bold text-gray-900 border border-neutral-600" colSpan={1}>
    Sl. No
  </TableCell>
...
{CentralGovtTaxlines.map((line, index) => (
        <TableRow key={index}>
          <TableCell className="px-2 py-2 text-sm font-medium text-neutral-500 border-collapse border border-neutral-600 " colSpan={1}>
            <input
...
<TableRow>
  <TableCell className="px-2 py-2 text-sm font-bold text-gray-900 border border-neutral-600 text-center" colSpan={7}>
...
<TableRow>
  <TableCell className="px-2 py-4 text-center text-sm font-bold text-gray-900 border border-neutral-600" colSpan={1}>
    Sl. No
  </TableCell>
  ...
  <TableCell colSpan={14}>
    <TableRow>
        <TableCell className="text-sm font-bold text-gray-900 border text-center border-neutral-600" colSpan={14}>
